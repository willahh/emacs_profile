...
(load-file "~/.emacs.d/include/use-package.el")
...
(load-file "~/.emacs.d/include/web-mode.el")
(load-file "~/.emacs.d/include/syntax-checker.el")
...
(load-file "~/.emacs.d/include/simple-httpd.el")
