...
* Bloquant
:VISIBILITY:
- [ ] Remettre le comportemment normal pour la touche supr
- [ ] [fram layout] Activer par défaut : window divider : bottom and right
- [ ] [fram layout] Activer par défaut : Fringe : left only
- [ ] [fram layout] Activer par défaut : Scrollbar horizontales
