...
* Bloquant
:VISIBILITY: all
- [ ] [js2] Désactiver Paredit pour le mode js2
- [ ] [ag] Ouvrir les resultats dans la même fenêtre
- [ ] [recenter]
  - [ ] Jump to mark
  - [ ] i-search (Comme dans Sublime)
- [ ] [yas] Ne fonctionne plus
- [ ] [multi-cursor] Autoriser le [M-v]
- [ ] [org-mode] Truncate line by default
- [ ] [pdf-mode] Scroll page next/prev
- [ ] [vc-dir] Déclencher le vc-dir en mode fullscreen avec la touche
...
- [ ] [org-mode] YAS n'est pas chargé
- [ ] [css-mode] Ne pas ajouter les entrées de DABREV
