...
* Tasks
:VISIBILITY: all
** TODO EM : C-h dans mini buffer n'exécute pas la bonne action
   [2017-08-08 Tue]
   [[file:~/org/main.org::*Goaland][Goaland]]
** TODO em C-h ne fonctionne pas dans le mini panneau du bas (visible sur l'ouverture d'n fichier)
   [2017-08-07 Mon]
** TODO C-; ne déclenche plus yassnippet
   [2017-08-07 Mon]
   [[file:~/www/project/easy3p/easy3p_3.1/dev/module/vvisual/list/js/process/role/Role.js::cl]]



** TODO em : Nouvelle frame : Mettre le mode projectile sur le buffer actif
   [2017-07-28 Fri]
   [[file:~/.Trash]]
** TODO Voir pour retirer les onglets du haut
** TODO M-z lorsqu'une sélection est présente = cela ne fonctionne pas



** TODO Ag result buffer : C-o : Open in new window
** TODO Réduire la hauteur du bandeau du bas
** TODO Activer le highlight en mode php
** TODO Remettre trailing whitespace sauf pour eww
** TODO Remettre un bind pour org mode pour faire des checkbox
** TODO Tester l'alternative a AG pour la recherche (le plus récent)
** TODO Mini buffer : Ne pas afficher lde scrollbar
** TODO Ajouter un bind ALT + arrow up / down sur drags
** TODO Faire fonctionner company dans des fichiers js avec des lignes
  dans le style suivant : 
require('./../goa/widget/inputSuggest/InputSuggest.js');
** TODO Activer Paredit sur le racourcis C-h (delete backward)
** TODO Les caractères ^M sont de nouveau visibles en mode php (vue
  certains en mode lisp aussi mais moins dérangeant)

** TODO Paredit-mode : l'auto protection de quote lorsque l'on saisie du
  ...
  Retirer les binds de paredit suivants sur tous les modes autre que
  lisp emac lisp clojure : ' " backspace delete
...
** TODO @work Warning (flycheck): Syntax checker css-csslint reported too many
  errors (1415) and is disabled. 
** TODO Ediff depuis un fichier, la commande q ne rétablie pas bien les
  buffers
** TODO [helm] Plugin helm utiisable avec la souris
...
** TODO [man] Autofocus sur la fenêtre
** TODO [common] M-v -> Paste and indent ?
** TODO flyspell mode ne doit pas etre actif par default car il
    consomme beaucoup
** TODO mshell / shell + Abbrev autocomplete :
...
** TODO Faire un fichier org nomme main.org Lorsqu'une nouvelle frame
...
** TODO Recenter after go to line number
** TODO Commande : Commentaire sans retour à la ligne, binder sur C-/  
** TODO Help mode evil : add q binding pour quitter
** TODO Helm imenu : Add advice recenter line
...
** TODO [web-mode] Ne pas remplacer les fin de ligne windows par des fins de ligne unix
** TODO [emacs-osxs] new centered frame : Le mode par default devrait être le mode text
** TODO [emacs-osxs] Vérifier les keybindings sur les touches alt (alt+n alt+p, etc)
** TODO [vc-dir] Déclencher le vc-dir en mode fullscreen avec la touche semble
...
** TODO [vc-dir] Ne pas afficher les "up-to-date"
