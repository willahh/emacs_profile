...
* Bloquant
:VISIBILITY: all
- [ ] Voir pour retirer les onglets du haut
- [ ] Ag result buffer : C-o : Open in new window
- [ ] M-z lorsqu'une sélection est présente = cela ne fonctionne pas
- [ ] Réduire la hauteur du bandeau du bas
- [ ] Faire fonctionner les ALT+DELETE et ALT+shift+delete

- [ ] Activer le highlight en mode php
- [ ] Remettre trailing whitespace sauf pour eww
- [ ] Remettre un bind pour org mode pour faire des checkbox


- [ ] Tester l'alternative a AG pour la recherche (le plus récent)
- [ ] Mini buffer : Ne pas afficher lde scrollbar
- [ ] Ajouter un bind ALT + arrow up / down sur drags
- [ ] Faire fonctionner company dans des fichiers js avec des lignes
  dans le style suivant : 
require('./../goa/widget/inputSuggest/InputSuggest.js');
- [ ] Activer Paredit sur le racourcis C-h (delete backward)
...
- [ ] Les caractères ^M sont de nouveau visibles en mode php (vue
