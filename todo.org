...
- [ ] [org] Voir regrouper tous les fichiers todo.org ensembles
      De façon à retrouver les projets / notes importantes facilement
- [ ] [custom] Faire une fonction recenter and enlarge frame
  - Agrandis la frame courante sur un ratio de 16:9
  - Re centre la frame
  - Binder sur C-x M-j
