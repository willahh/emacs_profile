...
** Bloquant
- [ ] Nouvelle window : Ne pas reequilibrer les fenetres....
- [ ] JS2 trop de couleurs
...
- [ ] [php-mode] [company-mode] Ajouter les snippets de php
      Peut sont-il déjas fournis depuis ac-php
