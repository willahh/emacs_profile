...
- [ ] Activer par défaut window divider : bottom and right
- [ ] Activer par défaul : Fringe : left only
- [ ] Activer par défaut : Scrollbar horizontales



- [ ] flyspell mode ne doit pas etre actif par default car il
    consomme beaucoup
- [ ] M-w ne ferme plus la frame courante
