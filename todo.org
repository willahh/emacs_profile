...
** Bloquant
- [ ] [js2-mode] Lorsque l'on saisie une parenthàse, un espace est inséré juste avant, il ne faut surtout pas
- [ ] [js2-mode] Activer un highlight symbol en temps réel pour ce mode
- [ ] Il n'y a plus de hightlight du même symbole
...
- [ ] [paredit] Lorsque l'on saisie une parenthèse, un espace vient s'ajouter avant celle-ci, il faut bloquer ça
