...
** TODO [#A] [PHP Mode] & [js2-mode] : Double clic sur un mot avec un $ -----> Le $ n'est pas sélectionné
   [2017-11-10 Fri]
...
** TODO Il faudrait voir pour faire tourner 2 instances d emacs, 
   [2017-11-15 Wed]

** TODO web mode update syntax word pour ne pas sélectionner le $ dans un mot
   [2017-11-15 Wed]
