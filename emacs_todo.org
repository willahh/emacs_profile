...
* Tasks
  :VISIBILITY: content
** TODO Mettre le caractere # dans les word bidul (double clic code couleur)
...
** DONE theme : Selection mettre un bleu plus foncé
   [2017-11-16 Thu]
...
** DONE Faire fonctionner projectile dans un nouveau buffer
   [2017-11-17 Fri]
   [[file:~/www/project/arsia/goacrop/src/utils.js:://]]

** TODO SHIFT + ENTER -> Meme comportement que SHIFT+J
   [2017-11-17 Fri]
   [[file:~/www/project/arsia/goacrop/src/utils.js:://]]

** DONE Theme : Match bracket bleu
   [2017-11-16 Thu]
   [[file:~/www/project/arsia/goacrop/src/events.js::y:%20Utils.getYForOutput(goacrop.Main.cropper.getData().y),][file:~/www/project/arsia/goacrop/src/events.js::y: Utils.getYForOutput(goacrop.Main.cropper.getData().y),]]
...
** TODO Comment - Remettre comme avant
   [2017-11-27 Mon]
   [[file:~/www/project/businessmanager/dev/admin/layout/style_new.css::}]]
