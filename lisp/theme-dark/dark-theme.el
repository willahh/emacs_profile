...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   '(link ((t (:foreground nil))))
   '(dired-header ((t (:foreground "#48fa7b" :background "#1a1c1d"))))
   '(dired-directory ((t (:foreground "#8be9fd" :background "#1a1c1d"))))
   '(dired-perm-write ((t (:foreground "#34aeff" :background "#1a1c1d"))))
   '(web-mode-current-element-highlight-face ((t (:foreground nil :background "#60a467"))))
   '(vhl/default-face ((t (:background "#000" :foreground nil))))
   '(font-lock-variable-name-face ((t (:foreground "#8be9fd"))))
   '(font-lock-function-name-face ((t (:foreground "#ff79c6"))))
   '(font-lock-keyword-face ((t (:foreground "#bd93f9"))))
   '(magit-diff-removed-highlight ((t (:background "#1a1c1d" :foreground "#ff536a"))))
   '(magit-diff-removed ((t (:background "#1a1c1d" :foreground "#ff536a"))))
   '(magit-diff-added ((t (:background "#1a1c1d" :foreground "#c3e886"))))
   '(magit-diff-added-highlight ((t (:background "#1a1c1d" :foreground "#c3e886"))))
   '(diff-header ((t (:background "#161718" :foreground "#fff"))))
   '(diff-file-header ((t (:background "#1a1c1d" :foreground "#fff"))))
   '(diff-hunk-header ((t (:background "#333" :foreground "#fff" :box "#666"))))
   '(diff-indicator-removed ((t (:background "#1a1c1d" :foreground "#86d9fb"))))
   '(diff-indicator-added ((t (:background "#1a1c1d" :foreground "#86d9fb"))))
   '(diff-removed ((t (:background "#1a1c1d" :foreground "#ff536a"))))
   '(diff-context ((t (:background "#1a1c1d" :foreground "#ccc"))))
   '(diff-header ((t (:background "#1a1c1d" :foreground "#fff"))))
   '(magit-diff-context-highlight ((t (:background "#1a1c1d"))))
   '(ediff-even-diff-A ((t (:foreground nil :background "#000"))))
   '(ediff-even-diff-B ((t (:foreground nil :background "#000"))))
   '(ediff-odd-diff-A ((t (:foreground nil :background "#000"))))
   '(ediff-odd-diff-B ((t (:foreground nil :background "#000"))))
   '(hl-line ((t (:foreground nil :background "#1d2027"))))
   '(company-tooltip-annotation ((t (:foreground "#55e97b"))))
   '(company-tooltip-common-selection ((t (:foreground "#00faff"))))
   '(diff-hl-delete ((t (:foreground "#fc1a9f" :background "#74245c"))))
   '(diff-hl-change ((t (:foreground "#5fbfec" :background "#3c6078"))))
   '(diff-hl-insert ((t (:foreground "#70ee00" :background "#36494b"))))
   '(hydra-face-amaranth ((t (:foreground "#70ee00"))))
   '(hydra-face-blue ((t (:foreground "#5fbfec"))))
   '(hydra-face-pink ((t (:foreground "#fc1a9f"))))
   '(hydra-face-red ((t (:foreground "#fc1a9f"))))
   '(hydra-face-teal ((t (:foreground "#5fbfec"))))
   '(scroll-bar ((t (:background "#282a36"))))
   '(tide-hl-identifier-face ((t (:background "#356a4b" :foreground "#ffffff" :underline "yellow"))))
   '(link ((t (:foreground nil))))
   '(lazy-highlight ((t (:background "green"))))
   '(scroll-bar ((t (:background "#000"))))
   '(tide-hl-identifier-face ((t (:background "#356a4b" :foreground "#ffffff" :underline "yellow"))))
   '(default ((t (:background "#1a1c1d"))))
   '(trailing-whitespace ((t (:background "#0f1010"))))
   '(web-mode-whitespace-face ((t (:background "#0f1010"))))
   '(highlight-symbol-face ((t (:foreground nil :background "#2f3b41"))))
   '(window-divider ((t (:foreground "#1a1c1d"))))
   '(window-divider-first-pixel ((t (:foreground "#1a1c1d"))))
   '(window-divider-last-pixel ((t (:foreground "#1a1c1d"))))
   '(js2-error ((t (:foreground "#fff"))))
   '(default ((t (:background "#1a1c1d"))))
   '(trailing-whitespace ((t (:background "#0f1010"))))
   '(web-mode-whitespace-face ((t (:background "#0f1010"))))
   '(js2-error ((t (:foreground "#fff"))))
   '(yas-field-highlight-face ((t (:foreground "#fff":background "#000"))))
   '(highlight-symbol-face ((t (:foreground nil :background "#2f3b41"))))
   ;; '(fringe ((t (:background nil :slant 'normal))))
   ;; '(fringe ((t (:background "#1a1c1d" :slant 'normal))))
   '(window-divider ((t (:foreground "#1a1c1d"))))
   '(window-divider-first-pixel ((t (:foreground "#1a1c1d"))))
   '(window-divider-last-pixel ((t (:foreground "#1a1c1d"))))
   '(region ((t (:background "#275f99" :foreground nil))))
